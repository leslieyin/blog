...
features: # 可选的
  - title: 收藏
    details: 收藏各类网站、应用、资料等
    link: /collect/iosapp.html # 可选
    imgUrl: https://cdn.jsdelivr.net/gh/leslieyin/dns@0.5/blog/public/img/collect.png # 可选
  - title: 文档
    details: 工作文档整理，学习文档
    link: /doc/
